...
std::string makeStructured(const std::string& message, int64_t userId, int64_t chatId,
...
void Logger::info(const std::string& message, int64_t userId, int64_t chatId,
                  const std::string& command) {
    get()->log(spdlog::level::info, makeStructured(message, userId, chatId, command));
}

void Logger::warn(const std::string& message, int64_t userId, int64_t chatId,
                  const std::string& command) {
    get()->log(spdlog::level::warn, makeStructured(message, userId, chatId, command));
}

void Logger::error(const std::string& message, int64_t userId, int64_t chatId,
                   const std::string& command) {
    get()->log(spdlog::level::err, makeStructured(message, userId, chatId, command));
}
